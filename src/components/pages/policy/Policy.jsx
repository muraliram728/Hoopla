    ...
    return (
        <div className="privacy-wrapper">
            <div className="privacy-container">
                ...
                <p className="privacy-updated">Last updated: September 16, 2025</p>

                <p>
                    This Privacy Policy describes how Greenmind Travel (the "Site", "we",
                    "us", or "our") collects, uses, and discloses your personal information
                    when you visit, use our services, or make a purchase from
                    www.greenmindtravel.com (the "Site") or otherwise communicate with us
                ...
                <h2 className="privacy-subtitle">How We Collect and Use Your Personal Information</h2>
                ...
                <p>
                    ...
                    we collect about you to communicate with you, provide or improve or
                    improve the Services, comply with any applicable legal obligations,
                    enforce any applicable terms of service, and to protect or defend the Services,
                    our rights, and the rights of our users or others.
                </p>

                <h2 className="privacy-subtitle">What Personal Information We Collect</h2>

                <p>
                    The types of personal information we obtain about you depends on
                    how you interact with our Site and use our Services. When we use the term "personal information",
                    we are referring to information that identifies, relates to, describes or can be associated with you.
                    The following sections describe the categories and specific types of personal information we collect.
                </p>

                <h2 className="privacy-subtitle">Information We Collect Directly from You</h2>
                ...
                <div className="responsive-list-container">
                    <ul className="responsive-list">
                        <li><strong>Contact details</strong> details including your name, address, phone number, and email.</li>
                        <li><strong>Order information</strong> information including your name, billing address, shipping address, payment confirmation, email address, and phone number.</li>
                        <li><strong>Account information </strong> information including your username, password, security questions and other information used for account security purposes.</li>
                        <li><strong>Customer support information</strong> support information including the information you choose to include in communications with us, for example, when sending a message through the Services.</li>
                    </ul>
                </div>
                <p>Some features of the Services may require you to directly provide us with certain information about yourself.
                    You may elect not to provide this information, but doing so may prevent you from using or accessing these features.</p>

                <h2 className="privacy-subtitle">Information We Collect about Your Usage</h2>

                <p>
                    We may also automatically collect certain information about your interaction with the Services ("<strong>Usage Data</strong>").
                    To do this, we may use cookies, pixels and similar technologies ("<strong>Cookies</strong>").
                    Usage Data may include information about how you access and use our Site and your account,
                    including device information, browser information, information about your network connection,
                    your IP address and other information regarding your interaction with the Services.
                </p>

                <h2 className="privacy-subtitle">Information We Obtain from Third Parties</h2>
                ...
                <div className="responsive-list-container">
                    <ul className="responsive-list">
                        ...
                        <li>Our payment processors, who collect payment information
                            (e.g., bank account, credit or debit card information, billing address)
                            to process your payment in order to fulfill your orders and provide you with products
                            or services you have requested, in order to perform our contract with you.</li>

                        <li>When you visit our Site, open or click on emails we send you, or interact with
                            our Services or advertisements, we, or third parties we work with, may
                            automatically collect certain information using online tracking technologies
                            such as pixels, web beacons, software developer kits, third-party libraries, and cookies.</li>
                ...
                <h2 className="privacy-subtitle">How We Disclose Personal Information</h2>
                ...
                <p>We disclose the following categories of personal information and sensitive personal information about users for the purposes set out above in <em>"How we Collect and Use your Personal Information"</em> and <em>"How we Disclose Personal Information":</em></p>
                ...
                <h2 className="privacy-subtitle">Third Party Websites and Links</h2>
                ...
                <h2 className="privacy-subtitle">Children's Data</h2>
                ...
                <h2 className="privacy-subtitle">Security and Retention of Your Information</h2>
                ...
                <h2 className="privacy-subtitle">International Users</h2>
                ...
                <p>
                    Should you have any questions about our privacy practices or this Privacy Policy, or if you would like to exercise any of the rights available to you, please call or email us at hooplaaholidays@gmail.com or contact us at Namakkal, Tamil Nadu, India, IN.
                </p>
